...
def _bench_one(
    ...
    # Triton- and Helion-backed recipes skip torch.compile — they're already kernels.
    if recipe_obj.use_triton_kernel or recipe_obj.use_helion_kernel:
    ...
    def run():
        return fn(
            ...
            use_helion_kernel=recipe_obj.use_helion_kernel,
        )
